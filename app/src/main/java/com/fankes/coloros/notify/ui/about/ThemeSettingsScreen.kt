...
import com.fankes.coloros.notify.ui.theme.MaxDensityScale
import com.fankes.coloros.notify.ui.theme.MinDensityScale
import com.fankes.coloros.notify.ui.theme.ThemeAccentColor
import com.fankes.coloros.notify.ui.theme.ThemeColorModes
import com.fankes.coloros.notify.ui.theme.ThemeConfig
import com.fankes.coloros.notify.ui.theme.ThemePaletteStyles
import com.fankes.coloros.notify.ui.theme.label
import com.fankes.coloros.notify.ui.theme.normalizeDensityScale
import com.fankes.coloros.notify.ui.theme.themeColorModeLabel
import com.fankes.coloros.notify.ui.theme.writeThemeConfig
...
fun ThemeSettingsScreen(
    ...
    var isPredictiveBackEnabled by remember(themeConfig.predictiveBackToHomeEnabled) {
        mutableStateOf(themeConfig.predictiveBackToHomeEnabled)
    }
                        ...
                        add(CardItem("predictiveBack") {
                            SwitchPreference(
                                ...
                                onCheckedChange = { checked ->
                                    ...
                                    updateTheme(themeConfig.copy(predictiveBackToHomeEnabled = checked))
                                    applyPredictiveBackCallbackEnabled(context, checked)
                                    onPredictiveBackChange?.invoke(checked)
                                },
                            )
                        })
                    }
